...
public class Notification_MSUApprovePage_45073 extends BasePage{
	
	public Notification_MSUApprovePage_45073(WebDriver driver) {
		super(driver);
	...
	public void approval2(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		// TC_45073 (Automation Regression : Web Approvals - MSU - Approve Swap NA with Confirmed unit(s))
		...
		//Login with SA to check notification
		 ...
		 waitSleep(9);		 
		 ExtentTestManager.getTest().log(LogStatus.INFO," Automation Regression : Web Approvals - MSU - Approve Swap NA with Confirmed unit(s)");
		 userlogin.click(); 
		 waitSleep(5);
