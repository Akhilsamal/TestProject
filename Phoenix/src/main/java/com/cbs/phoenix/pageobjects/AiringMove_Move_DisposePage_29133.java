...
public class AiringMove_Move_DisposePage_29133 extends BasePage {
	
	public AiringMove_Move_DisposePage_29133(WebDriver driver) {
		super(driver);
	...
	public void move(TestDataProvider testDataProvider, String testId) throws IOException, InterruptedException {
		...
		// TC_29133(Automation Regression : Move Airing: Move an airing and dispose of units into the destination time slot airing)

		
		ExtentTestManager.getTest().log(LogStatus.INFO,"  Automation Regression : Move Airing: Move an airing and dispose of units into the destination time slot airing ");
		...
		// Daypart
			...
			ExtentTestManager.getTest().log(LogStatus.PASS," First show details ");
			addScreenShot();
			...
			if (X_NEW1.contains(".")) {
				X_NEW11 = X_NEW1.split("\\.")[0];
						...
						ExtentTestManager.getTest().log(LogStatus.PASS," Second show details ");
						addScreenShot();
						waitSleep(4);
