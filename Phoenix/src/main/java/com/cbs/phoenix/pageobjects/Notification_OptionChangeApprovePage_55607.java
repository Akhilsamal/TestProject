...
public class Notification_OptionChangeApprovePage_55607 extends BasePage {
	
	public Notification_OptionChangeApprovePage_55607(WebDriver driver) {
		super(driver);
	...
	public void approval(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		//Login with DVP and Approve the deal
		 ...
		 // searchapprovals1.sendKeys(tcData.get("DealNum")); 
		  ...
		  ExtentTestManager.getTest().log(LogStatus.PASS,"Approve button clicked successfully .");
		  addScreenShot();
		  ExtentTestManager.getTest().log(LogStatus.PASS,"Click on Yes button.");		 
		  clickYesBtn.click();		  
		  waitSleep(20);
		  
		/*
		 * clickRejectbtn.click(); waitSleep(50);
		 */		  
		  ExtentTestManager.getTest().log(LogStatus.PASS,"  Approve the cuts back successfully ");
		 ...
		 * clickRejectbtn.click(); waitSleep(50);
		 */		  
		  ExtentTestManager.getTest().log(LogStatus.PASS,"  Approve the deal successfully ");	  
