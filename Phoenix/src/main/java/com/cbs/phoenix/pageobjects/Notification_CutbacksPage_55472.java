...
public class Notification_CutbacksPage_55472 extends BasePage {
	
	public Notification_CutbacksPage_55472(WebDriver driver) {
		super(driver);
	...
	public void approval(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		//Login with DVP and Reject the deal
		  ...
		  waitSleep(50);		  
		  ExtentTestManager.getTest().log(LogStatus.PASS,"  Reject the cuts back successfully "); 		  
