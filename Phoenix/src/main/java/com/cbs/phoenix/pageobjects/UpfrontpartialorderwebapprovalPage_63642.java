...
public class UpfrontpartialorderwebapprovalPage_63642 extends BasePage {
	...
	public UpfrontpartialorderwebapprovalPage_63642(WebDriver driver) {
		super(driver);
	...
	public void approval(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		// TC_63642 Automation Regression : Upfront deal - Upfront partial order web approval
