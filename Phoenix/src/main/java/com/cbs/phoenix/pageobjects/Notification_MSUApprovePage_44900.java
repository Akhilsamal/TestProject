...
public class Notification_MSUApprovePage_44900 extends BasePage{
	
	public Notification_MSUApprovePage_44900(WebDriver driver) {
		super(driver);
	...
	public void approval2(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		// TC_44900 (Test Case 44900: Automation Regression : Web Approvals - MSU - Delete unit in the past on Scatter Hold)
		...
		//Login with SA to check notification
		 ...
		 waitSleep(9);		 
		 ExtentTestManager.getTest().log(LogStatus.INFO," Test Case 44900: Automation Regression : Web Approvals - MSU - Delete unit in the past on Scatter Hold");
		 userlogin.click(); 
		 waitSleep(5);
