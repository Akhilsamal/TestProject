...
public class Notification_ChangeRequest_DoOverPage_44988 extends BasePage {
	
	
	public Notification_ChangeRequest_DoOverPage_44988(WebDriver driver) {
		super(driver);
	...
	public void approval(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		// TC_44988(Automation Regression : Web Approvals_Change Request_Do-Over-Add Network Commercial-Upfront Order)
		...
		//Login with SA to check notification
		 ...
		 waitSleep(9);		 
		 ExtentTestManager.getTest().log(LogStatus.INFO,"Automation Regression : Web Approvals_Change Request_Do-Over-Add Network Commercial-Upfront Order");
		 userlogin.click(); 
		 waitSleep(5);
