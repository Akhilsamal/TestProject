...
public class UpfrontPlanRequestWebApprovalPage_44321 extends BasePage {
	...
	public UpfrontPlanRequestWebApprovalPage_44321(WebDriver driver) {
		super(driver);
	...
	public void approval(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		// TC_44321 (Automation Regression : Upfront deal - Upfront Plan Request Web Approval)
		
		
		  //Login with DVP
		  
		  waitSleep(9); userlogin.click(); waitSleep(5);
		  
		  switchuserbtn.click(); waitSleep(5);
		  
		  selectuser.click(); waitSleep(6);
		  
		  selectuser.sendKeys(tcData.get("Daytime DVP")); waitSleep(6);
		  selectuser.click(); waitSleep(6);
		  
		  Loginbtn.click(); waitSleep(6);
		  
		  notification.click(); waitSleep(8);
		  
		  approvals.click(); waitSleep(5);
		  
		  searchapprovals.click(); waitSleep(3);
		  searchapprovals.sendKeys(tcData.get("DealNum")); waitSleep(5);
		  ...
		  userlogin.click(); waitSleep(5);
		  
		  switchuserbtn.click(); waitSleep(5);
		  
		  selectuser.click(); waitSleep(6);
		  
		  selectuser.sendKeys(tcData.get("Planner")); waitSleep(6); selectuser.click();
		  waitSleep(6);
		  ...
		  searchnotifications.click(); waitSleep(3);
		  searchnotifications.sendKeys(tcData.get("DealNum")); waitSleep(5);
		  ...
		  selectuser.sendKeys(tcData.get("Daytime AE")); waitSleep(6);
		  selectuser.click(); waitSleep(6);
		...
		//Login with Super Approver
		  ...
		  selectuser.sendKeys(tcData.get("Super Approver")); waitSleep(6);
		  selectuser.click(); waitSleep(6);
		...
		//5th step approval  by super approver
		  ...
		  clickApprovebtn.click(); waitSleep(8);
