...
public class ScatterHoldWebApprovalPage_44325 extends BasePage {
	...
	public ScatterHoldWebApprovalPage_44325(WebDriver driver) {
		super(driver);
		PageFactory.initElements(driver, this);
	}

	public void approval1(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		waitSleep(3);
		searchapprovals.sendKeys(tcData.get("ScatterHoldNum"));
		waitSleep(5);
		...
		waitSleep(3);
		searchnotifications.sendKeys(tcData.get("ScatterHoldNum"));
		waitSleep(5);
