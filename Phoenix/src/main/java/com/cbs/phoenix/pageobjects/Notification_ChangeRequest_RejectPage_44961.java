...
public class Notification_ChangeRequest_RejectPage_44961 extends BasePage {
	
	public Notification_ChangeRequest_RejectPage_44961(WebDriver driver) {
		super(driver);
	...
	public void approval(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		// TC_44961(Automation Regression : Web Approvals_Change Request_Reject - Add Network Commercial - Upfront Order)
