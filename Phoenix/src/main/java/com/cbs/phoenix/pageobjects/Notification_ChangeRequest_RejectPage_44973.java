...
public class Notification_ChangeRequest_RejectPage_44973 extends BasePage {
	
	public Notification_ChangeRequest_RejectPage_44973(WebDriver driver) {
		super(driver);
	...
	public void approval(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		// TC_44973(Automation Regression : Web Approvals_Change Request_Reject - Multi-way Flip)
