...
public class Notification_ChangeRequest_RejectPage_44963 extends BasePage {
	public Notification_ChangeRequest_RejectPage_44963(WebDriver driver) {
		super(driver);
	...
	public void approval(TestDataProvider testDataProvider, String testId) throws IOException {
		...
		// TC_44963(Automation Regression : Web Approvals - Change Request_Reject - Allocation CR reject - Scatter Order)
